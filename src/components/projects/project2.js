    ...
    <Box className="Project1">
      ...
      <Box as="main">
        <Box as="section" id="home">
          <Box as="h1">3D Engine/Renderer</Box>
          <Box as="p" className="ProjectInfoBox" id="project2"> A 3D Engine based in C++, using matrices and data points to render objects in a 3D space on a 2D screen. Based
            on mathematical functions and linear algebra. Not very efficient, but a great start for understanding the concepts and theories of 3D Engines.
          </Box>
